package com.github.deusvalen.expensetracer.db;
...
import com.github.deusvalen.expensetracer.providers.ExpensesContract.Categories;
import com.github.deusvalen.expensetracer.providers.ExpensesContract.Expenses;
...
public class ExpenseDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // Заполнение таблицы предопределенными значениями
